...
local hio_sp = [g.pnode({
      type: 'HDF5FrameTap',
      name: 'hio_sp%d' % anode.data.ident,
      data: {
        anode: wc.tn(anode),
        trace_tags: ['loose_lf%d' % anode.data.ident
        , 'tight_lf%d' % anode.data.ident
        , 'cleanup_roi%d' % anode.data.ident
        , 'break_roi_1st%d' % anode.data.ident
        , 'break_roi_2nd%d' % anode.data.ident
        , 'shrink_roi%d' % anode.data.ident
        , 'extend_roi%d' % anode.data.ident
        , 'mp3_roi%d' % anode.data.ident
        , 'mp2_roi%d' % anode.data.ident
        , 'decon_charge%d' % anode.data.ident
        , 'gauss%d' % anode.data.ident],
        filename: "g4-rec-%d.h5" % anode.data.ident,
        chunk: [0, 0], // ncol, nrow
        gzip: 2,
